...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Pet Amber web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 3u08CC96QnPisyD7Pz27Neo6ZzlgbUeYbKv4L3DHsek
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("pet-amber.log", "w"))
  #
  #
end
